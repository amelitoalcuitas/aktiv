...
@section('content')
    <style>
        ...
        .icon-circle { display: inline-block; width: 48px; height: 48px; background: #dbeafe; border-radius: 50%; line-height: 48px; font-size: 24px; margin-bottom: 12px; }
    ...
    <div class="btn-wrap">
        <a href="{{ $frontendUrl }}/dashboard/bookings?hubId={{ $hub->id }}&bookingId={{ $booking->id }}" class="btn">Go to Dashboard</a>
    </div>
@endsection
