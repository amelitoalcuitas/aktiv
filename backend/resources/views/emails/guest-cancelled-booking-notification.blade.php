...
@section('content')
    ...
    <div style="background:#f0f4f8; border-radius:8px; padding:16px; margin:24px 0; font-size:0.875rem;">
        <table style="width:100%; border-collapse:collapse;">
            <tr>
                ...
                <td style="padding:4px 0; text-align:right; font-weight:500; color:#0f1728;">{{ $booking->guest_name ?? $booking->bookedBy?->name ?? 'Guest' }}</td>
            </tr>
    ...
    <div style="text-align:center; margin:28px 0 8px;">
        <a href="{{ $frontendUrl }}/hubs/{{ $hub->id }}/bookings?bookingId={{ $booking->id }}" style="display:inline-block; background:#004e89; color:#fff; text-decoration:none; padding:12px 28px; border-radius:6px; font-size:0.9375rem; font-weight:600;">View in Dashboard</a>
    </div>
@endsection
