...
<head>
    ...
    <title>Booking Cancelled by Guest</title>
    <style>
        ...
        .icon { display: inline-block; width: 48px; height: 48px; background: #fee2e2; border-radius: 50%; line-height: 48px; font-size: 24px; margin-bottom: 12px; }
...
<body>
    <div class="container">
        ...
        <div class="cta">
            <a href="{{ $frontendUrl }}/dashboard/bookings?hubId={{ $hub->id }}&bookingId={{ $booking->id }}">View in Dashboard</a>
        </div>
