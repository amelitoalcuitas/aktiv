...
@section('content')
    ...
    <div style="text-align:center; margin-bottom:28px;">
        ...
        <h1 style="margin:0 0 4px; font-size:1.25rem; color:#0f1728;">Participant Cancelled Their Join</h1>
        <p style="color:#64748b; font-size:0.875rem; margin:0;"><strong>{{ $participantName }}</strong> cancelled their join for your <strong>{{ $sport }}</strong> session at <strong>{{ $hub->name }}</strong>.</p>
    </div>
