...
@section('title', 'Open Play Session Cancelled — Aktiv')
...
@section('content')
    ...
    <div style="text-align:center; margin-bottom:28px;">
        ...
        <h1 style="margin:0 0 4px; font-size:1.25rem; color:#0f1728;">Session Cancelled</h1>
        <p style="color:#64748b; font-size:0.875rem; margin:0;"><strong>{{ $hub->name }}</strong> has cancelled the <strong>{{ $sport }}</strong> open play session.</p>
    </div>
    ...
    <p style="font-size:0.875rem; color:#64748b; text-align:center;">We're sorry for the inconvenience. Check the hub's page for other upcoming sessions.</p>
