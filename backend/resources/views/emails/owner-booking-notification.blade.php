...
@section('title', 'New Booking — Aktiv')
...
@section('content')
    <div style="text-align:center; margin-bottom:28px;">
        ...
        <h1 style="margin:0 0 4px; font-size:1.25rem; color:#0f1728;">New Booking Received</h1>
        <p style="color:#64748b; font-size:0.875rem; margin:0;">A new booking has been made at <strong>{{ $hub->name }}</strong>.</p>
    </div>
    ...
    <div style="text-align:center; margin:28px 0 8px;">
        <a href="{{ $frontendUrl }}/hubs/{{ $hub->id }}/bookings?bookingId={{ $booking->id }}" style="display:inline-block; background:#004e89; color:#fff; text-decoration:none; padding:12px 28px; border-radius:6px; font-size:0.9375rem; font-weight:600;">Open Owner Dashboard</a>
    </div>
@endsection
