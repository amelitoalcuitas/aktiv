...
@section('content')
    <div style="text-align:center; margin-bottom:28px;">
        ...
        <h1 style="margin:0 0 4px; font-size:1.25rem; color:#0f1728;">Verify Your Email</h1>
        <p style="color:#64748b; font-size:0.875rem; margin:0;">Hi <strong>{{ $name }}</strong>, welcome to Aktiv!</p>
    </div>
    ...
    <div style="text-align:center; margin:28px 0;">
        <a href="{{ $verificationUrl }}" style="display:inline-block; background:#004e89; color:#fff; text-decoration:none; font-size:0.9375rem; font-weight:600; padding:12px 32px; border-radius:8px;">Verify Email Address</a>
    </div>
