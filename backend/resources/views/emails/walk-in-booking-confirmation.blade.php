...
@section('content')
    <style>
        ...
        .code-section { text-align: center; margin: 24px 0; }
    ...
    <div class="code-section">
        <p class="code-label" style="margin-bottom:4px;">Your booking code</p>
    ...
    <div class="btn-wrap">
        <a href="{{ $frontendUrl }}/booking/track/{{ $guestTrackingToken }}" class="btn">Track Your Booking</a>
    </div>
    @endif
@endsection
